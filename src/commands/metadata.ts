...
export const ChatCommandMetadata: {
    ...
    AVISO: {
        ...
        name: Lang.getRef('chatCommands.aviso', Language.Default),
        name_localizations: Lang.getRefLocalizationMap('chatCommands.aviso'),
        description: Lang.getRef('commandDescs.aviso', Language.Default),
        description_localizations: Lang.getRefLocalizationMap('commandDescs.aviso'),
        dm_permission: false,
